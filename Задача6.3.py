...
all_w = Position('Alex', 'Anderson', 'Director', 2000, 10000)
print('Full name: ' + all_w.get_full_name())
print('Postion in company: ' + all_w.position)
print('Income: ' + str(all_w.get_total_income()) + ' per month')