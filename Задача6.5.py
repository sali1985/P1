...
class Pen(Stationary):
    ...
    def draw(self):
        return f'Вы взяли {self.title}. Начало отрисовки ручкой'
...
class Pencil(Stationary):
    ...
    def draw(self):
        return f'Вы взяли {self.title}. Начало отрисовки карандашом'
...
class Handle(Stationary):
    ...
    def draw(self):
        return f'Вы взяли {self.title}. Начало отрисовки маркером'
